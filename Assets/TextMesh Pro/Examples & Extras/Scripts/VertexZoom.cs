        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    Vector2[] sourceUVs0 = cachedMeshInfoVertexData[materialIndex].uvs0.Select(v => new Vector2(v.x, v.y)).ToArray();
                    Vector2[] destinationUVs0 = textInfo.meshInfo[materialIndex].uvs0.Select(v => new Vector2(v.x, v.y)).ToArray();
